...
namespace DuQ.Migrations
{
    ...
    [Migration("20240302025322_AddDuQueuePositionsTable")]
    partial class AddDuQueuePositionsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DuQ.Data.DuQueuePosition", b =>
                {
                    ...
                    b.Property<Guid?>("DuQueueId")
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("DuQueueTypeId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("DuQueueId");

                    b.HasIndex("DuQueueTypeId");

                    b.ToTable("DuQueuePositions");
                });
            ...
            modelBuilder.Entity("DuQ.Data.DuQueuePosition", b =>
                {
                    b.HasOne("DuQ.Data.DuQueue", "DuQueue")
                        .WithMany()
                        .HasForeignKey("DuQueueId");

                    b.HasOne("DuQ.Data.DuQueueType", "DuQueueType")
                        .WithMany()
                        .HasForeignKey("DuQueueTypeId");

                    b.Navigation("DuQueue");

                    b.Navigation("DuQueueType");
                });
